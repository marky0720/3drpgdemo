...
effectHandler::effectHandler(IrrlichtDevice* dev, dimension2d<u32> mapSize, core::stringc shaderFolder, irr::core::dimension2d<irr::u32> screenRTTSize)
{
	...
	stringc temp="";
	temp+=mapSize.Height;
	sPP->addShaderDefine("MAPRES",temp);

	ScreenRTTSize = (screenRTTSize == dimension2d<u32>(0,0)) ? driver->getScreenSize() : screenRTTSize;
			   ...
			   (driver->getDriverType() == EDT_DIRECT3D9 && driver->queryFeature(EVDF_PIXEL_SHADER_1_4))))
	{
			...
			*depthLink = 200;
			...
			if(driver->queryFeature(EVDF_PIXEL_SHADER_2_0) || driver->getDriverType() == EDT_OPENGL)
			{
				...
				sPP->addShaderDefine("SAMPLE_AMOUNT",t1);
				...
				stringc t4="4";
				sPP->addShaderDefine("SAMPLE_AMOUNT",t4);
				...
				stringc t7="7";
				sPP->addShaderDefine("SAMPLE_AMOUNT",t7);
				...
				stringc t12="12";
				sPP->addShaderDefine("SAMPLE_AMOUNT",t12);
				...
				stringc t16="16";
				sPP->addShaderDefine("SAMPLE_AMOUNT",t16);
				if(driver->queryFeature(EVDF_PIXEL_SHADER_3_0) || driver->getDriverType() == EDT_OPENGL)
...
void effectHandler::addPostProcessingEffectFromFile(irr::core::stringc filename)
{
	...
	stringc w="";
	w+=ScreenRTTSize.Width;
	sPP.addShaderDefine("SCREENX",w);
	stringc h="";
	h+=ScreenRTTSize.Height;
	sPP.addShaderDefine("SCREENY",h);
